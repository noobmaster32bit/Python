...
# 2 runtime > 150
# runtime=[m.get("title") for m in movies if int(m.get("runtime"))>150]
# print(runtime)
...
#yearwise how many films was released (using dictionary ie {"year":"no.of movies"})

# movies_year={}

# for m in movies:
#     year=m.get("year")
#     if year in movies_year:        
#         movies_year[year]+=1
#     else:
#         movies_year[year]=1
# print(movies_year)
...
# most_movies_year=[(v,k) for(k,v) in movies_year.items()]
# print(max(most_movies_year))

# movie from id

# film_id=int(input("Enter movie id : "))
# for m in movies:
#     if film_id==m.get("id"):
#         print(m.get("title"))
...
g_c=[(v,k) for (k,v) in genre_count.items()]
print(max(g_c))
